...
from nat.plugins.temporal.data_models import TemporalWorkflowFunctionConfig


def test_temporal_function_config():
    """Test that TemporalWorkflowFunctionConfig can be instantiated with required fields."""
    config = TemporalWorkflowFunctionConfig(config_file="/path/to/config.yml")
...
def test_temporal_function_config_with_optional_fields():
    """Test TemporalWorkflowFunctionConfig with all optional fields set."""
    config = TemporalWorkflowFunctionConfig(config_file="/path/to/config.yml",
